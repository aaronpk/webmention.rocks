        ...
        <div style="padding: 12px 12px 3px 12px;">
          ...
          <p class="help-text">
            <?php 
              switch($type) {
                case 'like':
                  ?>The profile icons below are the <a href="https://indieweb.org/authorship">author</a> photos from people who have posted a "like" post on their site, where their post links to this post with the <code><a href="https://indieweb.org/like-of">like-of</a></code> property.</p><?php
                  break;
                case 'repost':
                  ?>The profile icons below are the <a href="https://indieweb.org/authorship">author</a> photos from people who have posted a "repost" of this post on their site, where their post links to this post with the <code><a href="https://indieweb.org/repost-of">repost-of</a></code> property.</p><?php
                  break;
                case 'bookmark':
                  ?>The profile icons below are the <a href="https://indieweb.org/authorship">author</a> photos from people who have posted a bookmark of this post on their site, where their post links to this post with the <code><a href="https://indieweb.org/bookmark-of">bookmark-of</a></code> property.</p><?php
                  break;
              }
            ?>
          </p>
